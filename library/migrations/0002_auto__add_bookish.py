...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Bookish'
        db.create_table(u'library_bookish', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('login_cookie', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
        ))
        db.send_create_signal(u'library', ['Bookish'])


    def backwards(self, orm):
        # Deleting model 'Bookish'
        db.delete_table(u'library_bookish')
    ...
    models = {
        ...
        u'library.bookish': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'login_cookie': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
